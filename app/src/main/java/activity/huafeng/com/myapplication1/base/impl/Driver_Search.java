...
public class Driver_Search extends BasePager {

    private static final String TAG = "Driver_Cooperation";
    ...
    public Driver_Search(BaseActivity activity) {
        super( activity );
    }
    ...
    public void initView() {
        ...
        if(isInited){
            ...
            thisRootView = View.inflate( mActivity, R.layout.pager_driver_search, null );

            //xRecycleView
            recyclerView = thisRootView.findViewById( R.id.pager_driver_search_recycleview );
    ...
    public class MyRecycleAdapter extends XRecyclerView.Adapter<MyRecycleAdapter.MyHolder> {
        ...
        public MyRecycleAdapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pager_driver_search, parent, false);
...
//            holder.state.setText( list .get(position ) .getZt());
        ...
        public class MyHolder extends XRecyclerView.ViewHolder {
            ...
            public MyHolder(View itemView) {
                ...
                //在这里查找holder中的控件.
                num=itemView .findViewById(R.id.pager_driver_search_num) ;
                qsd = itemView.findViewById(R.id.pager_driver_search_qsd_textview);
                zdd = itemView.findViewById(R.id.pager_driver_search_zdd_textview);
                name=itemView .findViewById(R.id.pager_driver_search_cargoname) ;
                type=itemView .findViewById(R.id.pager_driver_search_cargotype) ;
                lname=itemView .findViewById(R.id.pager_driver_search_lname) ;
                time=itemView .findViewById(R.id.pager_driver_search_time) ;
                state =itemView .findViewById(R.id.pager_driver_search_zt) ;
    ...
    private void request_order(final int currPage){
        ...
        OkGo.<String>get( UrlUtil.URL_Prefix + "Task/GetSjLs")
