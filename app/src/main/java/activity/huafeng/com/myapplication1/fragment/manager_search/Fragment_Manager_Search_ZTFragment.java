...
import activity.huafeng.com.myapplication1.activity.Location_LookDriverActivity;
...
public class Fragment_Manager_Search_ZTFragment extends BaseFragment_No_InitData {
    private static final String TAG = "Fragment_Manager_Search_ZTFragment";
    ...
    @SuppressLint("ValidFragment")
    public Fragment_Manager_Search_ZTFragment(BaseActivity mActivity) {
        super(mActivity);
    }
    ...
    public View initView() {
        ...
        noContent = view.findViewById(R.id.pager_manager_search_nocontent);
    ...
    public class MyRecycleAdapter extends XRecyclerView.Adapter<MyRecycleAdapter.MyHolder> {
        ...
        public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pager_manager_statezt, parent, false);
        ...
        public void onBindViewHolder(final MyHolder holder, final int position) {
            ...
            holder .itemView .setOnClickListener( new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Hawk .put("numtxt",list .get(position ).getRwbh()) ;
                    Hawk .put("qsdtxt",list .get(position ) .getQsd()) ;
                    Hawk .put("zddtxt",list .get(position ).getZdd()) ;
                    Hawk .put("cargonametxt",list .get(position ) .getHwmc()) ;
                    Hawk .put("cargotypetxt",list .get(position) .getDw()) ;
                    Hawk .put("nametxt",list .get(position) .getSjxm()) ;
                    Hawk .put("carnumtxt",list .get(position) .getCph()) ;
                    Hawk .put("timetxt",list .get(position) .getLrsj()) ;
                    Hawk .put("dhtxt",list .get( position  ).getSjdh()) ;
                    Hawk .put("cxtxt",list .get( position  ).getCx()) ;
                    Hawk .put("addresstxt",list .get( position  ).getAddress()) ;
                    Hawk .put("longtxt",list .get( position  ).getJd()) ;
                    Hawk .put("lattxt",list .get( position  ).getWd()) ;

                //    Hawk .put("ztLocation",bean.getData() ) ;
                    Intent intent =new Intent(mActivity , Location_LookDriverActivity.class) ;
    ...
    private void request_order(final int currPage){
        ...
        OkGo.<String>get( UrlUtil.URL_Prefix + "Task/GetCdZd" )
